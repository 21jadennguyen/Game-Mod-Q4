...
const int IMPULSE_16			= 16;			// Spawn dummy
...
const int IMPULSE_23			= 23;			// use winmon
const int IMPULSE_24			= 24;			// prev winmon
const int IMPULSE_25			= 25;			// next winmon
const int IMPULSE_26			= 26;			// prev winmon move
const int IMPULSE_27			= 27;			// next winmon move
...
const int IMPULSE_111			= 111;			// spawn dummy
