...
const int IMPULSE_23			= 23;			// Winmon 7
const int IMPULSE_24			= 24;			// Winmon 8
const int IMPULSE_25			= 25;			// Winmon 9
const int IMPULSE_26			= 26;			// Winmon 10
...
const int IMPULSE_111			= 111;			// Winmon 1
const int IMPULSE_112			= 112;			// Winmon 2
const int IMPULSE_113			= 113;			// Winmon 3
const int IMPULSE_114			= 114;			// Winmon 4
const int IMPULSE_115			= 115;			// Winmon 5
const int IMPULSE_116			= 116;			// Winmon 6
